...
const ALL_BADGES = [
  ...
  {id:'first_watch',cat:'learning',emoji:'👀',name:'First Watch',hint:'Set your first price alert'},
  {id:'serious_watch',cat:'learning',emoji:'🎯',name:'Serious Watchman',hint:'Set 10 price alerts'},
  {id:'veteran_watch',cat:'learning',emoji:'🔭',name:'Veteran Watchman',hint:'Set 20+ price alerts over time'},
  ...
  {id:'bought_dip',cat:'situational',emoji:'📉',name:'Bought The Dip',hint:'Buy after a 5%+ price drop'},
  ...
  {id:'fee_conscious',cat:'simulation',emoji:'💸',name:'Fee Conscious',hint:'Keep total fees under $10'},
];
