...
const LESSONS = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    blocks: [
      ...
      { block_type: 'heading', content: { text: '📺 Watch & Learn' } },
      { block_type: 'video', content: { url: 'https://www.youtube.com/watch?v=pGzfexGmuVw', title: 'What is a Stablecoin? (How they work - ANIMATED) — Whiteboard Crypto', description: 'Whiteboard Crypto covers why stablecoins exist, how fiat-collateralized (USDC, USDT), crypto-collateralized (DAI), and algorithmic stablecoins each maintain their $1 peg — and why algorithmic ones tend to be fragile.' } },
