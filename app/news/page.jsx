...
import ArticleThumbnail, { SOURCE_COLORS } from "@/components/ArticleThumbnail";
...
function ArticleTile({ article, featured=false }) {
  ...
  return (
    ...
    >
      <ArticleThumbnail imageUrl={article.image_url} source={article.source} height={imgHeight} />
